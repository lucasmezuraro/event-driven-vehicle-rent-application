...
public class TestMainController {
    ...
    @Test
    public void controllerShouldExists() throws Exception {
        assertThat(this.mainController).isNotNull();
    }

    @Test
    public void controllerIndexMethodMustReturnString() throws Exception {
        this.mockMvc
                .perform(get("/"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("It's working")));
    }
}
